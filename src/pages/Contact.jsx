    ...
    >
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="">
          ...
          <form action="">
            <input type="text" className="mb-3 w-1/2 px-4 py-2 rounded-lg" name="" id="" placeholder="Your name" /><br />
            <input type="text" className="mb-3 w-1/2 px-4 py-2 rounded-lg" name="" id="" placeholder="Your message" /><br />
            <button className="btn bg-red-400 border-none text-white hover:text-black">Submit</button>
          </form>
        </div>
      </div>
    </div>
